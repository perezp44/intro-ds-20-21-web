...
#### **Instalación de paquetes** 
  ...
  - Para instalar los paquetes que usaremos en el curso tienes que pinchar [aquí](./mas-recursos/paquetes-R-a-instalar.R) o [aquí](https://github.com/perezp44/intro-ds-20-21-web/blob/master/mas-recursos/paquetes-R-a-instalar.R) y se te abrirá una ventana diciendo que se va a abrir un fichero con `RStudio`. Acepta. Se abrirá RStudio y el fichero, entonces, pincha con el botón derecho del ratón y se abrirá un  menú contextual. Selecciona la opción **"Select All"**.
