...
date: "Noviembre de 2017 (actualizado el `r format(Sys.time(), '%d-%m-%Y')`)"
output:
  html_document:
...
meta() %>% meta_name("github-repo" = "perezp44/intro-ds-20-21-web") %>% 
  meta_social(
    title = "Importar y exportar datos en R",
    description = paste("En este tutorial aprenderemos a, desde RStudio, importar y exportar datos en diferentes formatos, usando paquetes como readr, readxl y rio."),
    url = "https://perezp44.github.io/intro-ds-20-21-web/tutoriales/tt_04_cargar_datos.html",
    og_type = "website",
