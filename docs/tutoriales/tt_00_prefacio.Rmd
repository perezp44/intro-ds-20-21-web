...
meta() %>% meta_name("github-repo" = "perezp44/intro-ds-20-21-web") %>% 
  meta_social(
    title = "Prefacio al curso Programación y manejo de datos en la era del Big data con R",
    description = paste(
      "Se indican las intenciones y la conveniencia del curso.",
      "Se hace un resumen de contenidos del curso."),
    url = "https://perezp44.github.io/intro-ds-20-21-web/tutoriales/tt_00_prefacio.html",
