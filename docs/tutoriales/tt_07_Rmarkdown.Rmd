...
meta() %>% meta_name("github-repo" = "perezp44/intro-ds-20-21-web") %>% 
  meta_social(
    title = "Documentos reproducibles con Rmarkdown",
    description = paste(
      "Introducción a la generación de documentos reproducibles con Rmarkdown"),
    url = "https://perezp44.github.io/intro-ds-20-21-web/tutoriales/tt_07_Rmarkdown.html",
    og_type = "website",
