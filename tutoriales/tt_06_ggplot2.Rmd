---
title: "Visualización con ggplot2 (WIP)"
...
Como también se aprende los errores, [aquí](https://medium.economist.com/mistakes-weve-drawn-a-few-8cdd8a42d368){target="_blank"} tienes un articulo de The Economist donde muestran errores que ellos mismos han cometido haciendo gráficos. Además pueden descargarse los datos.Otro ejemplo de gráfico un poquito tendencioso, esta vez del Washington Post:


```{r, echo = FALSE, fig.asp = 7/9}
tweetrmd::tweet_embed("https://twitter.com/andypressman/status/1122512664813604865", theme = "light", align = "center", maxwidth = 400)
```
