...
En [este hilo](https://twitter.com/GoldbergData/status/1292935454195511302) de Twitter se habla sobre los mejores paquetes R para hacer tablas. En él, [David Keyes](https://rfortherestofus.com/author/dgkeyes/) hace [aquí](https://rfortherestofus.com/2019/11/how-to-make-beautiful-tables-in-r/) un buen tutorial sobre paquetes para hacer tablas en R.
...
R es un lenguaje/entorno para hacer análisis estadísticos, así que muchas veces se han de presentar los resultados de estimación de algún modelo estadístico, PERO, los resultados de estimación de estos modelos, en general, no se almacenan en data.frames, sino en listas. ¿Es esto importante? Sí, si queremos presentar los resultados de estimación en una tabla, porque los paquetes para tablas que hemos visto anteriormente (`gt`, `DT`, etc ...) solo generar tablas de resultados almacenados en data.frames, así que no los podremos usar, al menos directamente. Afortunadamente hay unos cuantos paquetes en R cuyo propósito es precisamente presentar los resultados de estimación de algún modelo o técnica estadística como tablas.
