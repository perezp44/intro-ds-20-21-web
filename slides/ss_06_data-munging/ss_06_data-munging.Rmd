---
title: "Data munging: the tidyverse way"
subtitle: "-- Slides 06 --"  
author: 
  - "Pedro J. Pérez"
date: '`r Sys.Date()`'
...
knitr::include_graphics("./imagenes/ss_06_img_01_data-wrangle.png")
```
...
knitr::include_graphics("./imagenes/ss_06_img_02_grizlly-vs-teddy.jpg")
```
...
---
background-image: url(imagenes/ss_06_img_03_tidyverse-hex.png)
...
knitr::include_graphics("./imagenes/ss_06_img_05_pkgs-tidyverse.png")
```
]
...
knitr::include_graphics("./imagenes/ss_06_img_04_pipe-hex.png")
```

---
class: inverse, center, middle
background-image: url(imagenes/ss_06_img_04_pipe-hex.png)
background-position: 95% 5%
background-size: 15%
...
---
class: inverse, center, middle
background-image: url(imagenes/ss_06_img_06_tidyr-hex.png)
background-position: 95% 5%
background-size: 15%
...
Unos datos son tidy si: (1) cada columna es una variable, (2) cada fila es una observación y (3) cada valor debe estar en su propia celda.
...
knitr::include_graphics("./imagenes/ss_06_img_11_tidy-data.png")
```
...
knitr::include_graphics("./imagenes/ss_06_img_09_wide-long.png")
```
...
```{r,  echo = FALSE, eval = TRUE, fig.asp = 4/2, out.width = "90%", fig.align = "center"}
knitr::include_graphics("./imagenes/ss_06_img_10_wide-long.png")
```
...
---
class: inverse, center, middle
background-image: url(imagenes/ss_06_img_07_dplyr-hex-new.png)
background-position: 95% 5%
background-size: 15%
...
Y después de `dplyr 1.0.0`, en mayo de 2020, 2 más:
...
En análisis de datos muchas operaciones  queremos calcularlas para distintos grupos (hombre, mujer ...). `group_by()` permite hacerlo.
...
```{r , echo=FALSE, eval = TRUE, fig.asp = 4/2, out.width = "75%", fig.align = "center"}
knitr::include_graphics("./imagenes/ss_06_img_12_inner-join.png")
```
...
```{r , echo=FALSE, eval = TRUE, fig.asp = 4/2, out.width = "75%", fig.align = "center"}
knitr::include_graphics("./imagenes/ss_06_img_13_full-join.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 4/2, out.width = "75%", fig.align = "center"}
knitr::include_graphics("./imagenes/ss_06_img_14_left-join.png")
```
