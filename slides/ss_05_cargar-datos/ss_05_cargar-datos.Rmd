...
meta() %>% meta_name("github-repo" = "perezp44/intro-ds-20-21-web") %>% 
  meta_social(
    title = "Importar (y exportar) datos con R",
     description = paste("En esta clase aprenderemos a, desde RStudio, importar y exportar datos en diferentes formatos, usando paquetes como readr, readxl y rio."),
    url = "https://perezp44.github.io/intro-ds-20-21-web/slides/ss_05_cargar-datos/ss_05_cargar-datos.html#1",
...
knitr::include_graphics("./imagenes/ss_05_img_01_cargar-datos.png")
```
