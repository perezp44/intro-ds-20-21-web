...
Como sabéis, la asignatura se imparte en el primer semestre del cuarto curso del Grado en Economía. Es una asignatura optativa, código 36494, con una carga lectiva total de 6 ECTS. La asignatura es una **introducción a la ciencia de datos**: pretende iniciar a los estudiantes en este campo presentando una panorámica de tópicos, y exponiéndoos, quizás por primera vez en la carrera, a la programación.


De momento, 1 de septiembre, **está previsto que las clases se desarrollen de manera presencial**^[Las clases está previsto que sean presenciales, **PERO** habrá limitaciones a la movilidad dentro de las clases, incluso parece que será obligatorio el uso de mascarillas, así que será más difícil entenderse, pero lo intentaremos!!], pero es posible (esperemos que no!!) que tengamos que cambiar a clases online. Ya lo veremos!!
