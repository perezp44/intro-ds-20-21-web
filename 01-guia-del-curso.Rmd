...
En esta sección voy a tratar de contaros un poco la filosofía/enfoque del curso y, principalmente, cómo será la forma de trabajar en clase y en casa^[Tenéis también que tener claro que lo que voy a escribir aquí puede estar sujeto a cambios, ¿qué porqué pueden haber haber cambios? pues por muchas razones, una de ellas es evolución de la pandemia, otra es que aún no os conozco.]. También diré algo sobre la evaluación. Por favor, **leed completamente esta sección**. Es importante!!
...
Nos veremos un día a la semana. En esta misma web, en la sección [`Calendario`](https://perezp44.github.io/intro-ds-20-21-web/03-calendario.html) detallaré qué haremos en cada sesión, tanto en clase, como antes de venir a clase. Antes de venir a clase tendréis que realizar las tareas que tengáis asignadas para ese día, generalmente la tarea  leer algún material, pero otrsa veces tendreis que realizar alguna tarea que formará parte de la evaluación continua. Repito, **tendréis que hacer unas tareas antes de venir a clase**^[Algunas de ellas las recogeré y contarán como evaluación continua.]. 
...
Como os he dicho, las clases son los viernes, antes de cada clase publicaré en esta web, en la sección [`Calendario`](https://perezp44.github.io/intro-ds-20-21-web/03-calendario.html) el esquema de la clase, las transparencias que utilizaré y el trabajo previo que tendréis que hacer. Si puedo publicaré esos guiones no mas tarde de los lunes. Las transparencias puede que tarden un poco más, pero estarán disponibles en la web antes de cada clase.

El plan consiste en que vosotros hacéis el trabajo previo antes de venir a clase, de forma que el viernes podéis seguir sin demasiados problemas las clases. De vez en cuando os tendré que hacer una prueba en el aula que formará parte de la evaluación continua. 

Las pruebas saldrán bien, espero, lo que querrá decir que estáis aprendiendo, así que todos estaremos contentos y ademas cumpliremos las recomendaciones sanitarias asi que no tendremos problemas con el covid. Ojala!!


> Everyone has a plan until they get punched in the mouth --- Mike Tyson

A pesar de que confío en que tengamos suerte y podamos cumplir con "the plan", la verdad es que hay, creo, altas probabilidades de que igual (espero que no) la docencia pase a ser on-line. Ya veríamos que hacemos en ese caso, cruzad los dedos por si acaso.
...
El curso es eminentemente práctico, por lo que es necesario que los estudiantes tengan acceso a un ordenador durante las clases. Dada la situación sanitaria actual, las clases se impartirán en el aula 513 (aula de teoría) por lo que se hace **necesario que cada estudiante venga a clase con su propio portátil**.

Durante el curso utilizaremos diversos recursos: transparencias, ejemplos, ejercicios, bibliografia, etc... Puedes encontrar todos los detalles en la sección [`Logística`](https://perezp44.github.io/intro-ds-20-21-web/02-logistica.html) de la página web.
...
Daré los detalles concretos acerca de la evaluación continua la segunda o tercera semana del curso. Estos detalles se publicarán en el [`Aula Virtual`](https://aulavirtual.uv.es/course/view.php?id=9254)
...
En esta sección pretendo responder a posibles dudas/preguntas que creo que se os pueden pasar por la cabeza antes de iniciar el curso. Yo también tengo dudas sobre cómo será el curso: esta es la segunda vez que se imparte el curso en la UV, pero la primera (y espero que última) que se imparte bajo una situación de pandemia.
...
Creo que te resultará fácil aprobar; de hecho, el año pasado aprobaron todos los que siguieron el curso: todos eran capaces de importar y arreglar datos, mostar resultados en tablas y gráficos y presentar informes en Rmarkdown. 
...
Pues no lo sé, depende, pero cada vez es más frecuente que las empresas intenten hacer sus análisis y gestión de datos con R. El año pasado al menos dos estudiantes, que yo sepa,  utilizaron R en las empresas en las que estaban haciendo sus practicas curriculares y otros dos ahora mismo estarán cursando un máster de Análisis de Datos, así que seguro que ahora están usando R.
