...
- [**`Apuntes colaborativos en HackMD`**](https://hackmd.io/zUgsCA6zR4GzyojiS2YIZQ){target="_blank"}: para hacer apuntes colaborativos. Es como Google Docs pero en MD. Veremos si al final lo usamos, aún lo estoy probando.
...
- [Guía Docente](./pdfs/Guia-Docente.pdf)

- [Guía de instalación R y RStudio](./mas-recursos/Instrucciones_instalacion-a.html)
...
A continuación pondré algunos recursos que me parecen útiles, espero que no demasiados. De todas formas mira lo que dice Jesse Mostipak sobre aprender **#rstats**:
